...
public class UI {
    ...
    public static final String  ANSI_BLUE_BACKGROUND = "\u001B[44m"; // blue
    public static final String  ANSI_PURPLE_BACKGROUND = "\u001B[45m"; // purple
    public static final String  ANSI_CYAN_BACKGROUND = "\u001B[46m"; // cyan
    public static final String  ANSI_WHITE_BACKGROUND = "\u001B[47m"; // white
